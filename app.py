...
app = dash.Dash(external_stylesheets=[dbc.themes.CERULEAN, FONT_AWESOME])
...
app.layout = html.Div(
    [
        dbc.Row([dbc.Col(("Ultimo DATO")),
                dbc.Col(("MAXIMO")),
                dbc.Col(("PROMEDIO")),
                dbc.Col(("MINIMO"))], className="g-0")
        ,
        dbc.Row(
            [
                dbc.Col((card5)), 
        ...
        ,
        dbc.Row([dbc.Col(html.Div([card_soledad],style={"width": "18rem"},), width=3,),dbc.Col(html.Div(dbc.Card(dcc.Graph(id = 'my_graph3', figure = {})))),],className="g-0",)
        ,        
        dbc.Row([dbc.Col(html.Div([card_soledad],style={"width": "18rem"},), width=3,),dbc.Col(html.Div(dbc.Card(dcc.Graph(id = 'my_graph4', figure = {})))),],className="g-0",),
